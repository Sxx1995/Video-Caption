...
def download_videos():
    ...
    with youtube_dl.YoutubeDL(ydl_opts) as ydl:
        ydl.download(['https://www.youtube.com/watch?v=jqpAgMxhx30'])
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='/home/jxgu/github/video2text_jxgu/pytorch/data/msvtt/MSR_VTT/videodatainfo_2017.json', help='input json file to process into hdf5')
    parser.add_argument('--output_json', default='data/msvtt/MSR_VTT/msr_vtt.json', help='output json file')
    parser.add_argument('--output_h5', default='data/msvtt/MSR_VTT/msr_vtt_video', help='output h5 file')

    # options
    parser.add_argument('--max_length', default=16, type=int,
                        help='max length of a caption, in number of words. captions longer than this get clipped.')
    parser.add_argument('--images_root', default='/home/jxgu/github/im2text_jxgu/pytorch/data/mscoco',
