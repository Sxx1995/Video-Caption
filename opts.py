...
def parse_opt():
    ...
    parser.add_argument('--model_name', type=str, default='SSTA')
    ...
    # Hyper-parameters
    parser.add_argument('--projected_size', type=int, default=500)  # 'image attention'
    parser.add_argument('--hidden_size', type=int, default=1000)  # LSTM hidden size
    ...
    parser.add_argument('--num_words', type=int, default=30)  # Number of words length

    parser.add_argument('--ds', type=str, default='msr-vtt') #msr-vtt, msvd
    # MSR-VTT setting
    ...
    args.decoder_pth_path = os.path.join(args.result_dir, args.ds + '_decoder.pth')
    args.best_decoder_pth_path = os.path.join(args.result_dir, args.ds + '_best_decoder.pth')
    args.optimizer_pth_path = os.path.join(args.result_dir, args.ds + '_optimizer.pth')
    args.best_optimizer_pth_path = os.path.join(args.result_dir, args.ds + '_best_optimizer.pth')
