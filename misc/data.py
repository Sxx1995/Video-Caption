...
def get_train_loader(opt, cap_pkl, feature_h5, batch_size=10, shuffle=True, num_workers=3, pin_memory=True):
...
def get_eval_loader(opt, cap_pkl, feature_h5, batch_size=200, shuffle=False, num_workers=1, pin_memory=False):
